// VotersPanel — toda a UI de gestão de eleitores (filtros, lista, import/export,
// geocode em lote, CRUD). Componente puro, renderizado tanto pela página
// /eleitores (wrapper) quanto pelo modo "Eleitores" do Mapa.
//
// Quando usado dentro do Mapa, o `onFilteredChange` permite ao mapa pintar os
// pontos sincronizados com os filtros aplicados aqui.
...
interface VotersPanelProps {
  /** Avisa o pai sempre que a lista filtrada muda (usado pelo Mapa
   *  para sincronizar os pontos no mapa com os filtros do painel). */
  onFilteredChange?: (voters: Voter[]) => void;
}

export function VotersPanel({ onFilteredChange }: VotersPanelProps = {}) {
  ...
  // Sincroniza a lista filtrada com o pai (Mapa) sempre que ela muda.
  useEffect(() => {
